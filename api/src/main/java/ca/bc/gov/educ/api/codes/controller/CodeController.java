...
@CrossOrigin
@OpenAPIDefinition(info = @Info(title = "API for Code Tables Data.", description = "This API is for Reading Code Tables data.", version = "1"), security = {@SecurityRequirement(name = "OAUTH2", scopes = {"READ_GRAD_COUNTRY_CODE_DATA","READ_GRAD_PROVINCE_CODE_DATA","READ_GRAD_PROGRAM_CODE_DATA","READ_GRAD_UNGRAD_CODE_DATA","READ_GRAD_CERTIFICATE_CODE_DATA","READ_GRAD_MESSEGING_CODE_DATA","READ_GRAD_CAREER_PROGRAM_CODE_DATA"})})
public class CodeController {
    ...
    @PreAuthorize(PermissionsContants.READ_GRAD_UNGRAD)
    @Operation(summary = "Find a Ungrad Reasons by Ungrad Reasons Code", description = "Get a Ungrad Reasons by Ungrad Reasons Code", tags = { "Province" })
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK"), @ApiResponse(responseCode = "204", description = "NO CONTENT.")})
    ...
    @Operation(summary = "Update an Ungrad Reasons", description = "Update an Ungrad Reasons", tags = { "Ungrad Reasons" })
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
    ...
    @Operation(summary = "Delete an Ungrad Reasons", description = "Delete an Ungrad Reasons", tags = { "Ungrad Reasons" })
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
